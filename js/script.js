...
const commands = {
	...
	{
		cmd: 'members',
		res: 'BriccSquad Members:<span class="red"></span><br>#<span class="red"> Tristan (Tha OGGG)</span><br># <span class="red"> DOC (The procrastinator)</span><br># <span class="red"> Jackson (No comment)</span><br># <span class="red"> Gray (Brain dead)</span><br># <span class="red"> Isolate (who tf is this nikka)</span>'
	},
	clowns:
	{
		cmd: 'clowns',
	...
	{
		cmd: 'aboutme',
		res: 'About Me:<br># <span class="red">Real Name:</span> Tristan</span><br># <span class="red">Country:</span> Zimbabwe<br><br><span class="red">Bio:</span><br><span class="pink"><br>Sahh! The names tristan.<br>I know how to make cool things!<br>There are a lot of other people that are better than me<br>My discord is Tristan#9731 if you want to add me!<br></span><br># <span class="red">Programming:</span> HTML, CSS, JS, PHP, C++, C#, PY, LUA, JAVA.<br></span>'
	},
	links: 
	{
		cmd: 'links',
		res: 'Links:<br># <span class="red"><a href="https://discord.com/users/524753831242760207" target="_blank"><u>Discord</u></a></span> - My Discord Account.<br># <span class="red"><a href="https://github.com/StaffTP" target="_blank"><u>Github</u></a></span> - My Github.<br># <span class="red"><a href="https://steamcommunity.com/id/PosterXD/" target="_blank"><u>Steam</u></a></span> - You can find me there <span class="green">Online</span> most of the time.<br># <span class="red"><a href="https://tristanisgoated.github.io" target="_blank"><u>My Website</u></a></span> - My Website</span><br># <span class="red"><a href="https://www.youtube.com/c/StaffTPmc" target="_blank"><u>Youtube</u></a></span> - Some trash content, I post there.<br># <span class="red"><a href="https://tristangen.ml" target="_blank"><u>Private Generator</u></a></span> - Add my Discord for access.'
	},
	visitors: 
	{
		cmd: 'visitors',
	...
	{
		cmd: 'help',
		res: 'Available commands:<br><br># <span class="red">aboutme</span> - Some information about me.<br># <span class="red">clear</span> - Really, it just clear. <br># <span class="red">screenfetch</span> - Fetches system information in the terminal.<br># <span class="red">links</span> - Links for others sites.<br># <span class="red">visitors</span> - How many times people visited this site.<br># <span class="red">insta [Link]</span> - Get original instagram picture.<br># <span class="red">members</span> - Shows all current briccsquad members.<br># <span class="red">clowns</span> - Hall Of Clowns.'
	}
}
